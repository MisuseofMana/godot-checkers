...
const DARK_PIECE = preload("res://checkers/art/dark_piece.png")
const LIGHT_PIECE = preload("res://checkers/art/light_piece.png")
const DARK_KING = preload("res://checkers/art/dark-king.png")
const LIGHT_KING = preload("res://checkers/art/light-king.png")
